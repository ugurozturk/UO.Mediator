...
--------|----------|----------|-------
UOMA001 | Uozturk.Mediator.ApiExplorer | Error | Required host dependency is missing
UOMA002 | Uozturk.Mediator.ApiExplorer | Error | Marked request type is unsupported
UOMA003 | Uozturk.Mediator.ApiExplorer | Error | Generated endpoint route is invalid
