...
`Uozturk.Mediator.ApiExplorer.Generated`. Partial declarations must be in the
...
<PropertyGroup>
  ...
  <UozturkMediatorControllerPrefix>App</UozturkMediatorControllerPrefix>
  <UozturkMediatorControllerSuffix>Service</UozturkMediatorControllerSuffix>
</PropertyGroup>
```
