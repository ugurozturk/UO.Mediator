...
namespace Uozturk.Mediator;

/// <summary>
/// Registration API for the Uozturk.Mediator dispatcher.
/// </summary>
public static class UozturkMediatorServiceCollectionExtensions
{
    public static IServiceCollection AddUozturkMediator(
        this IServiceCollection services,
        params Assembly[] assemblies)
    {
        return services.AddUozturkMediator(_ => { }, assemblies);
    }
    ...
    public static IServiceProvider ValidateUozturkMediator(this IServiceProvider serviceProvider)
    {
